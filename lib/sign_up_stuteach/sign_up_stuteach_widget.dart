...
import 'sign_up_stuteach_model.dart';
export 'sign_up_stuteach_model.dart';

class SignUpStuteachWidget extends StatefulWidget {
  const SignUpStuteachWidget({super.key});

  @override
  State<SignUpStuteachWidget> createState() => _SignUpStuteachWidgetState();
}

class _SignUpStuteachWidgetState extends State<SignUpStuteachWidget>
    with TickerProviderStateMixin {
  late SignUpStuteachModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignUpStuteachModel());
                                  ...
                                  children: [
                                    Stack(
                                      children: [
                                        Align(
                                          alignment:
                                              const AlignmentDirectional(-0.33, -1.0),
                                          child: Padding(
                                            padding:
