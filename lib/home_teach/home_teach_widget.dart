...
import 'home_teach_model.dart';
export 'home_teach_model.dart';

class HomeTeachWidget extends StatefulWidget {
  const HomeTeachWidget({super.key});

  @override
  State<HomeTeachWidget> createState() => _HomeTeachWidgetState();
}

class _HomeTeachWidgetState extends State<HomeTeachWidget>
    with TickerProviderStateMixin {
  late HomeTeachModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeTeachModel());
